...
set PR_INSTALL=%LIQUID_HOME%\bin\ia64\prunsrv.exe
 
REM Service log configuration
set PR_LOGPREFIX=%SERVICE_NAME%
set PR_LOGPATH=%LIQUID_HOME%\logs
set PR_STDOUTPUT=%LIQUID_HOME%\logs\stdout.txt
set PR_STDERROR=%LIQUID_HOME%\logs\stderr.txt
set PR_LOGLEVEL=INFO
 
REM Path to java installation
set PR_JVM=C:\apps\Java\jdk1.6.0_41\jre\bin\server\jvm.dll
